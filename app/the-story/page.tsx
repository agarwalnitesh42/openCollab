  ...
  return (
    <div className="">
      <article className="container-custom-screen mt-12 prose prose-invert">
        <h1>About OpenCollab</h1>
        <p>
          Welcome to <strong>OpenCollab</strong>! We're a group of cool, young developers who came together with one mission: to create an
        ...
        <ul>
          <li>
            <a href="https://twitter.com/exp_nit">Nitesh Agarwal</a>
          </li>
        </ul>
        <h2>Our Story</h2>
        <p>
        ...
        <blockquote className="twitter-tweet">
          ...
          <a href="https://twitter.com/exp_nit">Dec 4, 2023</a>
        </blockquote>{' '}
